...
public class Penjualan extends javax.swing.JFrame {
    ...
    private void autonumber(){
        try {
            ...
            String sql = "SELECT * FROM tb_penjualan ORDER BY NoFaktur DESC";
    ...
    private void initComponents() {
        ...
        txTampil.setBackground(new java.awt.Color(51, 255, 51));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < baris; i++) {
                String sql = "INSERT INTO tb_penjualanrinci(NoFaktur, id_barang, nama_barang, jumlah_barang, harga_barang, total_harga) VALUES('"
