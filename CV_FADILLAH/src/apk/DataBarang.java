...
public class DataBarang extends javax.swing.JFrame {
    ...
    public void loadData(){
        ...
        try {
            ...
            System.out.println("terjadi kesalahan di load data");
        }
    }
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE tb_barang SET nama_barang = ?, harga_jual = ?, stok_barang = ? WHERE id_barang = ?";
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (pernyataan== JOptionPane.OK_OPTION) {
            try {
                ...
                System.out.println("Terjadi Kesalahan di delete barang");
            }finally{
                btnSimpan.setEnabled(true);
                btnEdit.setEnabled(false);
                btnHapus.setEnabled(false);
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            System.out.println("Terjadi Kesalahan di insert barang");
        }finally{
            autonumber();
            clear();
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String hargaJual = (String) model.getValueAt(i, 2);
