...
public class MenuAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("Registrasi Pengguna");
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        JInternalFrame internalframe = new JInternalFrame(judul,false,true,true);
        internalframe.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        internalframe.setContentPane(r.getContentPane());
        internalframe.setLocation((jDesktopPane1.getWidth()-r.getWidth())/2, (jDesktopPane1.getHeight()-r.getHeight())/2);
        internalframe.pack();
